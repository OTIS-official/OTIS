...
def otis_baseDeep_patchX_dec160d4b(**kwargs):    # nb_params: 7.1M encoder, 1.5M decoder
    model = OTIS(
...
def otis_baseDeep_patchX_dec128d2b(**kwargs):    # nb_params: 7.1M encoder, 0.57M decoder
    model = OTIS(
        embed_dim=192, depth=12, num_heads=3,                               # dim=64 per head
...
def otis_largeDeep_patchX_dec160d4b(**kwargs):   # nb_params: 40M encoder, 1.5M decoder
    model = OTIS(
...
def otis_largeDeep_patchX_dec128d2b(**kwargs):   # nb_params: 40M encoder, 0.60M decoder
    model = OTIS(
        embed_dim=384, depth=18, num_heads=6,                               # dim=64 per head
        decoder_embed_dim=128, decoder_depth=2, decoder_num_heads=4,        # dim=32 per head
        mlp_ratio=4, 
...
def otis_hugeDeep_patchX_dec160d4b(**kwargs):    # nb_params: 116M encoder, 1.5M decoder
    model = OTIS(
...
def otis_hugeDeep_patchX_dec128d2b(**kwargs):    # nb_params: 116M encoder, 0.63M decoder
    model = OTIS(
